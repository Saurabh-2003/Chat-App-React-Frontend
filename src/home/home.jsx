    ...
    return (
        <main className="w-full bg-gray-100">
            ...
            <div className="w-full mt-20 gap-16 lg:px-40 max-md:px-20 max-sm:px-0 flex flex-col items-center justify-center text-text-primary">
                <div className="flex max-sm:flex-col max-sm:px-0 gap-10 bg-white rounded-xl overflow-hidden pl-10 items-center w-full ">
                    ...
                    <img className="w-1/2 max-sm:w-full h-[400px] object-cover" src="https://images.unsplash.com/photo-1516321497487-e288fb19713f?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8Z3JvdXAlMjBjaGF0fGVufDB8fDB8fHww" alt="Group Communication" />
                </div>
                <div className="bg-white max-sm:flex-col max-sm:px-0 rounded-xl overflow-hidden pr-10 flex gap-10 items-center w-full mt-10 ">
                    <img className="w-1/2 max-sm:w-full object-cover h-[400px]" src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTR8fGdyb3VwJTIwY2hhdHxlbnwwfHwwfHx8MA%3D%3D" alt="End-to-end Encryption" />
                    <div className="w-1/2 max-sm:w-full max-sm:px-2">
                ...
                <div className="bg-white max-sm:flex-col max-sm:px-2 rounded-xl overflow-hidden pl-10 flex gap-10 items-center w-full mt-10 ">
                    <div className="w-1/2 max-sm:w-full max-sm:px-2">
                    ...
                    <img className="w-1/2 max-sm:w-full object-cover h-[400px]" src="https://images.unsplash.com/photo-1604881991720-f91add269bed?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fGdyb3VwJTIwY2hhdHxlbnwwfHwwfHx8MA%3D%3D" alt="Express Yourself" />
                </div>
            </div>

            {/* Fourth Panel */}
            <div className="w-[90%] py-10 mt-20   text-center flex flex-col gap-4 mx-auto h-fit rounded-xl  my-10 bg-white ">

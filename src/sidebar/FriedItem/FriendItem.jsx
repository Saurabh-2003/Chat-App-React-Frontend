    ...
    <div onClick={() => onFriendClick(friend._id)} className="hover:bg-gray-100 cursor-pointer flex items-center text-slate-600 justify-between p-4 border-b border-gray-200">
      ...
      {isConfirmationVisible && (
        <div className=" absolute z-10
         ml-48 mt-4 mr-4 bg-white border  border-gray-200 rounded-lg p-4">
          ...
          <div className=" flex w-full justify-between">
            ...
            <button onClick={(event) => hideConfirmation(event)} className="delete-reject bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded-md">No</button>
          </div>
        </div>
      )}
    </div>
